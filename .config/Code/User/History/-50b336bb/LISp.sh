...
wayland_pkgs="
    wayland xorg-xwayland hyprland xdg-desktop-portal-hyprland swww waybar rofi-wayland mako grim slurp"
apps="
...
function install_dots() {
    # SDDM and Default Cursor Theme Config
    sudo cp ./.config/index.theme /usr/share/icons/default/
    sudo cp -r ./TokyoNight-SDDM /usr/share/sddm/themes/ && sudo cp ./.config/sddm.conf /etc/
    ...
    sudo cp ./.config/grub /etc/default/ && sudo grub-mkconfig -o /boot/grub/grub.cfg
